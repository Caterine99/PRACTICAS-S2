---
title: 'UNIDAD 2: Práctica 07-Análisis estadístico de datos univariados discretos con R'
...
```{r}
barplot(tfre[[2]], main="Gráfico de barra", xlab="X = Número Hijos\n", ylab="frecuencia", col=c("yellow","blue", "green", "orange", "cyan","red"), sub="Agosto-2012")
```
...
```{r}
pie(tfre[[2]], main="Gráfico de pastel", xlab="Número Hijos \n", col=c("yellow", "blue", "green", "orange", "cyan", "red"), sub="Agosto-2012")
```
